...
import { MetaPixelSection } from "@/components/settings/MetaPixelSection";
...
const SPECIAL_PLATFORMS = [
  ...
  { id: "pixel_marketing", name: "Pixel de Marketing", description: "Meta Pixels via Conversions API para rastreamento de eventos", platform: "meta_pixel" },
];
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            {PlatformIcons[specialPanel === "openai" ? "openai" : specialPanel === "email_module" ? "email" : specialPanel === "pixel_marketing" ? "meta_pixel" : "custom_api"]}
        ...
        {specialPanel === "pixel_marketing" && <MetaPixelSection />}
      </div>
    );
  }
