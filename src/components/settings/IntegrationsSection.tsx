...
const PlatformIcons: Record<string, React.ReactNode> = {
  mercadopago: (
    <svg viewBox="0 0 48 24" className="h-7 w-8" fill="none">
      <ellipse cx="24" cy="12" rx="23" ry="11" fill="#009ee3"/>
      <path d="M29.5 9.5c-.4-1.8-2-3-4.2-3-1.4 0-2.7.6-3.3 1.6-.7-1-2-1.6-3.3-1.6-2.2 0-3.8 1.2-4.2 3-.5 2.4.8 5.4 3.8 8.2 1 .9 2.3 1.8 3.7 1.8s2.8-.9 3.7-1.8c3-2.8 4.3-5.8 3.8-8.2z" fill="#fff"/>
    </svg>
  ),
  openpix: (
